...
public class ThemeDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static void insertEnters2(SQLiteDatabase db, String tab, String theme, String text, String com) {
    ...
    private static void insertEnters3(SQLiteDatabase db, String tab, String theme, String qs, String tr, String com) {
        ContentValues textEnters = new ContentValues();
        textEnters.put("TAB", tab);
        textEnters.put("THEME", theme);
        textEnters.put("QS", qs);
        textEnters.put("TR", tr);
        textEnters.put("COM", com);
        db.insert("QS_TABLE", null, textEnters);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE TEXT_THEME (_id INTEGER PRIMARY KEY AUTOINCREMENT, TAB TEXT, THEME TEXT, TEXT TEXT, COM TEXT); ");
        Log.i("MyLog", "After create table2");


        //added note

        insertEnters2(db, "0", "Типы", "Примитивные типы Java не являются объектами. К ним относятся:", "0");
        insertEnters2(db, "0", "Типы", " boolean - булев тип, может иметь значения true или false", "0");
        insertEnters2(db, "0", "Типы", "byte - 8-разрядное целое число", "0");
        insertEnters2(db, "0", "Типы", " short - 16-разрядное целое число", "0");
        insertEnters2(db, "0", "Типы", " int - 32-разрядное целое число", "0");
        insertEnters2(db, "0", "Типы", " long - 64-разрядное целое число", "0");
        insertEnters2(db, "0", "Типы", " char - 16-разрядное беззнаковое целое, представляющее собой символ UTF-16 (буквы и цифры)", "0");
        insertEnters2(db, "0", "Типы", "float - 32-разрядное число в формате IEEE 754 с плавающей точкой", "0");
        insertEnters2(db, "0", "Типы", " double - 64-разрядное число в формате IEEE 754 с плавающей точкой", "0");
        insertEnters2(db, "0", "Типы", " Примитивный в данном случае не оскорбление, а просто даёт понять, что речь идёт о простом типе, который не умеет прыгать, спать или мяукать. Да что он вообще умеет? Ой, всё."
        ...
        insertEnters2(db, "0", "Типы", "", "0");
        insertEnters2(db, "0", "Типы", " byte c, a, t; // объявили сразу три переменные ", "0");
        insertEnters2(db, "0", "Типы", " ", "0");
        insertEnters2(db, "0", "Типы", " В арифметических выражениях с переменными типа byte вычисления выполняются как с типом int, т.е. с помощью 32-битовой арифметики, а полученный результат будет 32-битовым. Смотри пример с short." +
        ...
        insertEnters2(db,"1", "Побитовые операторы", "\n\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tВопросы\t\t", "1");
        ...
        insertEnters2(db,"1", "Операторы сравнения", "\n\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tВопросы\t\t", "1");
        ...
        insertEnters2(db,"1", "Логические операторы", "\n\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tВопросы\t\t", "1");
        ...
        insertEnters2(db,"1", "Оператор if", "\n\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tВопросы\t\t", "1");



        Log.i("MyLog", "After insert1");
        db.execSQL("CREATE TABLE QS_TABLE (_id INTEGER PRIMARY KEY AUTOINCREMENT, TAB TEXT, THEME TEXT, QS TEXT, TR TEXT, COM TEXT ); ");
        Log.i("MyLog", "After create table2");

        insertEnters3(db, "", "Типы", "Какого типа нету в java", "true", "0" );
        insertEnters3(db, "", "Типы", "bool", "true", "1" );
        insertEnters3(db, "", "Типы", "int", "false", "1" );
        insertEnters3(db, "", "Типы", "String", "false", "1" );
        insertEnters3(db, "", "Типы", "boolean", "false", "1" );

        insertEnters3(db, "", "Побитовые операторы", " int a = 5\n" +
                "a = a >> 2 \n" +
                "b = a << 4\n"+
                "Что выведеться на экран если сложить a и b", "false", "0" );
        insertEnters3(db, "", "Побитовые операторы", "5", "false", "1" );
        insertEnters3(db, "", "Побитовые операторы", "7", "false", "1" );
        insertEnters3(db, "", "Побитовые операторы", "17", "true", "1" );
        insertEnters3(db, "", "Побитовые операторы", "3", "false", "1" );

        insertEnters3(db, "", "Операторы сравнения", "Как в условии if проверяеться сравнение?", "false", "0");
        insertEnters3(db, "", "Операторы сравнения", "=", "false", "1" );
        insertEnters3(db, "", "Операторы сравнения", ">=", "false", "1" );
        insertEnters3(db, "", "Операторы сравнения", "!=", "false", "1" );
        insertEnters3(db, "", "Операторы сравнения", "==", "true", "1" );

        insertEnters3(db, "", "Логические операторы", "Как в if указать два одновременно выполняющих условия?", "true", "0" );
        insertEnters3(db, "", "Логические операторы", "||", "false", "1" );
        insertEnters3(db, "", "Логические операторы", "|=", "false", "1" );
        insertEnters3(db, "", "Логические операторы", "&&", "true", "1" );
        insertEnters3(db, "", "Логические операторы", "^", "false", "1" );

        insertEnters3(db, "", "Оператор if", "Какой оператор обезателен", "true", "0" );
        insertEnters3(db, "", "Оператор if", "if", "true", "1" );
        insertEnters3(db, "", "Оператор if", "if else", "false", "1" );
        insertEnters3(db, "", "Оператор if", "else", "false", "1" );
